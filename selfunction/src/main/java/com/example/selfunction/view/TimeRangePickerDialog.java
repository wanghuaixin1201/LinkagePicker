...
public class TimeRangePickerDialog extends Dialog {
    ...
    public TimeRangePickerDialog(Context context, String startAndEndTime, ConfirmAction confirmAction,String title) {
    ...
    private void initView() {
        ...
        mSpinners = findViewById(R.id.ll_father);
        llFirst = findViewById(R.id.rl_son);
...
//        llFirst = (LinearLayout) timePicker.getChildAt(0);
